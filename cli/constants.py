...
SLASH_COMMANDS: dict[str, str] = {
    ...
    "/models": "Search, browse, and switch models (interactive search)",
    "/model": "Switch model (/model <name> or interactive search)",
    "/providers": "Search, browse, and switch providers (interactive search)",
    "/provider": "Switch provider (/provider <name> or interactive search)",
